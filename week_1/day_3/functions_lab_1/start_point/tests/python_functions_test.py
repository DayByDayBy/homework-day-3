...
#   @unittest.skip("delete this line to run the test")
  def test_volume_of_cube(self):
    cube_edge = 5
    cube_volume = 125
    volume = (cube_edge)*(cube_edge)*(cube_edge)
    self.assertEqual(cube_volume, volume)
...
#   @unittest.skip("delete this line to run the test")
    ...
    #add test code here
     self.assertEqual(rev_string, (input_string[::-1]))
...
#   @unittest.skip("delete this line to run the test")
  def test_fahrenheit_to_celsius(self):
    c_temp = -3
    f_temp = 25
    self.assertEqual(c_temp, int(0.5556 * (f_temp-32)))
